...
export const AiAssistant = () => {
  ...
  const openai = new OpenAI({
    apiKey:
      ...
      "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",
  ...
  const handleSend = async () => {
    ...
    try {
      // Call OpenAI API to understand user intent
...
When users ask about roommates or housing, provide helpful responses.
